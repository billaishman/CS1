...
#This sets the variable (raining) to the string "none"
...
math = "none"
#this makes the variable equal none
while math.lower() not in ("yes", "no"):
...
hunger = "none"
while hunger.lower() not in ("yes", "no"):
...
cold = "none"
while cold.lower() not in ("yes", "no"):
    print("Are you cold?")
